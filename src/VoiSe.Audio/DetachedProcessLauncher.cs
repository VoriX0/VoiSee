...
/// <summary>
/// Starts a helper process with Explorer as its explicit parent. This keeps the
/// helper outside the VoiSee UI process tree, which is important when another
/// application captures audio from the VoiSee process and all of its children.
/// </summary>
    ...
    public static Process StartWithExplorerParent(string executablePath, string arguments)
    {
        ...
        if (parentHandle == IntPtr.Zero)
        {
            throw new Win32Exception(Marshal.GetLastWin32Error(),
                "Could not open Windows Explorer as the detached helper parent process.");
        }
        ...
        try
        {
            ...
            {
                throw new Win32Exception(Marshal.GetLastWin32Error(),
                    "Could not initialize the detached process attribute list.");
            }
            ...
            {
                throw new Win32Exception(Marshal.GetLastWin32Error(),
                    "Could not assign Windows Explorer as the detached helper parent process.");
            }
            ...
            {
                throw new Win32Exception(Marshal.GetLastWin32Error(),
                    "Could not start the isolated virtual microphone helper process.");
            }
