# Gate 12.2.4 — Voice Changer Modular Rack
...
12.2.3 changed effect insertion/reorder hit testing to the X axis for its horizontal lane. 12.2.4 restores Y-axis insertion math because the approved chain is vertical.
