...
## VoiSee 12.3.2 — Native Scrolling Rework
...
```text
artifacts\installer\VoiSee-Setup-12.3.2-x64.exe
```

Portable build:

```text
artifacts\installer\VoiSee-Portable-12.3.2-x64.zip
```
...
## 12.3.2 — Native scrolling rework
